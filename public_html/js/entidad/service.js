        ...
        return {
            getFields: function () {
                return [
                    ...
                    {name: "apellidos", shortname: "Apellidos", longname: "Apellidos", visible: true, type: "text", required: true, maxlength: 255, pattern: serverService.getRegExpr("nombre"), help: serverService.getRegExpl("nombre")},
                    ...
                    {name: "fecha_alta", shortname: "Alta", longname: "Fecha alta", visible: true, type: "date", required: true, pattern: ""},
                    {name: "fecha_baja", shortname: "Baja", longname: "Fecha baja", visible: true, type: "date", required: true, pattern: ""},
                    {name: "obj_sociedad", shortname: "Sociedad", longname: "Sociedad", visible: true, type: "foreign", reference: "sociedad", descforeign: "descripcion"}
                ];
            },
            getIcon: function () {
                return "fa-user";
