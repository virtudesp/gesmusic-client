'use strict';
moduloPrioridad.controller('PrioridadEditController', ['$scope', '$routeParams', '$location', 'prioridadService', 'serverService', 'postService', 'sharedSpaceService', '$filter', '$uibModal',
    function ($scope, $routeParams, $location, prioridadService, serverService, postService, sharedSpaceService, $filter, $uibModal) {
