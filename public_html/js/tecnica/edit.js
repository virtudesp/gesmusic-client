...
moduloTecnica.controller('TecnicaEditController', ['$scope', '$routeParams', '$location', 'tecnicaService', 'serverService', 'sharedSpaceService', '$filter', '$uibModal',
    function ($scope, $routeParams, $location, tecnicaService, serverService, sharedSpaceService, $filter, $uibModal) {
