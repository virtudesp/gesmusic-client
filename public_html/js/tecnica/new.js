...
moduloTecnica.controller('TecnicaNewController', ['$scope', '$routeParams', '$location', 'serverService', 'tecnicaService', 'sharedSpaceService', '$filter', '$uibModal',
    function ($scope, $routeParams, $location, serverService, tecnicaService, sharedSpaceService, $filter, $uibModal) {
