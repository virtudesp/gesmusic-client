        ...
        return {
            getFields: function () {
                return [
                    ...
                    {name: "fecha_alta", shortname: "Alta", longname: "Fecha alta", visible: false, type: "date", required: false, pattern: ""},
                    {name: "fecha_baja", shortname: "Baja", longname: "Fecha baja", visible: false, type: "date", required: false, pattern: ""},
                    {name: "obj_tipomiembro", shortname: "Tipo", longname: "Tipo miembro", visible: false, type: "foreign", reference: "tipomiembro", descforeign: "tipomiembro"}
                ];
            },
            getIcon: function () {
                return "fa-user";
