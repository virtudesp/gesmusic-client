    ...
    return {
        getFields: function () {
            return [
                ...
                {name: "address", shortname: "Dirección", longname: "Dirección", visible: false, type: "text", required: false, maxlength: 255},
                {name: "city", shortname: "Ciudad", longname: "Ciudad", visible: false, type: "text", required: true, maxlength: 255},
                {name: "zip", shortname: "Cód.Postal", longname: "Cód.Postal", visible: false, type: "text", required: false, maxlength: 255},
