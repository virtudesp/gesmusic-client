        ...
        return {
            getFields: function () {
                return [
                    ...
                    {name: "city", shortname: "Ciudad", longname: "Ciudad", visible: false, type: "text", required: true, maxlength: 255, pattern: serverService.getRegExpr("nombre"), help: serverService.getRegExpl("nombre")},
                    ...
                    {name: "state", shortname: "Provincia", longname: "Provincia", visible: false, type: "text", required: true, maxlength: 255, pattern: serverService.getRegExpr("nombre"), help: serverService.getRegExpl("nombre")},
